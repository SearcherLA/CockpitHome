...
class ResellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reseller" do
    assert_difference('Reseller.count') do
      post resellers_url, params: { reseller: { resname: @reseller.resname, shortcut: @reseller.shortcut } }
    end
  ...
  test "should update reseller" do
    patch reseller_url(@reseller), params: { reseller: { resname: @reseller.resname, shortcut: @reseller.shortcut } }
